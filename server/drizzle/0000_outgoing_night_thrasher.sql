CREATE TABLE "client_intakes" (
	...
	"service_responses" jsonb DEFAULT '{}'::jsonb,
...
ALTER TABLE "clients" ADD CONSTRAINT "clients_portal_workspace_id_workspaces_id_fk" FOREIGN KEY ("portal_workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "clients" ADD CONSTRAINT "clients_portal_project_id_projects_id_fk" FOREIGN KEY ("portal_project_id") REFERENCES "public"."projects"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "lead_intakes" ADD CONSTRAINT "lead_intakes_intake_id_client_intakes_id_fk" FOREIGN KEY ("intake_id") REFERENCES "public"."client_intakes"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "meetings" ADD CONSTRAINT "meetings_meeting_link_id_meeting_links_id_fk" FOREIGN KEY ("meeting_link_id") REFERENCES "public"."meeting_links"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "projects" ADD CONSTRAINT "projects_source_project_id_projects_id_fk" FOREIGN KEY ("source_project_id") REFERENCES "public"."projects"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "shared_files" ADD CONSTRAINT "shared_files_uploaded_by_users_id_fk" FOREIGN KEY ("uploaded_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_source_task_id_tasks_id_fk" FOREIGN KEY ("source_task_id") REFERENCES "public"."tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
