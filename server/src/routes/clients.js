...
router.post('/', async (req, res, next) => {
  try {
    ...
    await db.insert(clients).values({
      ...
      contactName: contactName || details?.contactName || null,
      contactRole: contactRole || details?.contactRole || null,
      email: email || null,
      phone: phone || null,
      website: website || null,
      industry: industry || null,
      serviceType: serviceType || details?.serviceType || null,
      businessDetails: businessDetails || details?.businessDetails || {},
      serviceResponses: serviceResponses || details?.serviceResponses || {},
      uploadedFiles: uploadedFiles || details?.uploadedFiles || [],
      calendlyEventId: calendlyEventId || details?.calendlyEventId || null,
      details: details || {},
      updatedAt: new Date(),
    });
