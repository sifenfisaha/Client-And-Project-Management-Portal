      ...
      <div className="flex flex-wrap gap-4 mb-4">
        ...
        {(filters.status ||
          ...
          <button
            ...
            className="px-3 py-1 flex items-center gap-2 rounded bg-linear-to-br from-purple-400 to-purple-500 text-zinc-100 dark:text-zinc-200 text-sm transition-colors"
          >
            ...
            {filteredTasks.length > 0 ? (
              filteredTasks.map((task) => {
                ...
                return (
                  <div
                    key={task.id}
                    className=" dark:bg-linear-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-zinc-300 dark:border-zinc-800 rounded-lg p-4 flex flex-col gap-2"
                  >
